...
The following visualizations combine insights from the OECD's publication, ["Main Science and Technology Indicators"]<a href="javascript:window.open(https://www.oecd-ilibrary.org/science-and-technology/main-science-and-technology-indicators_2304277x)>Nueva nueva ventana</a><br />, with the goal of showing the state of R&D in member countries.
